import type { LexicalSession } from '@workspace/ai-ops/ai-toolkit';
import { numberLines, serializeWithXml } from '@workspace/ai-ops/utils';
import { hasToolCall, stepCountIs, streamText } from 'ai';
import { type Span, Telemetry } from '../../shims/observability';
import API_COMPACT from '../prompts/API_COMPACT.md?raw';
import INTERPRET from '../prompts/INTERPRET.md?raw';
import SHARED from '../prompts/SHARED.md?raw';
import SUPERVISOR from '../prompts/SUPERVISOR.md?raw';
