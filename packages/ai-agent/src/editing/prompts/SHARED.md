...
- The document is shown to you as **a read-only structural XML _view_** -- the user sees the actual rendered rich text in their editor. The XML is never written back..
