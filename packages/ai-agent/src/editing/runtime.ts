...
import type { Doc } from '@workspace/ai-ops/doc';
...
import {
  ...
  runQueue,
  summarize,
} from '@workspace/ai-ops/queue';
import { serializeWithXml } from '@workspace/ai-ops/utils';
import { $getId } from '@workspace/lexical-nodes/plugins/nodeIdPlugin';
import { $getRoot, $isElementNode, type LexicalNode } from 'lexical';
import type { Span } from '../shims/observability';
