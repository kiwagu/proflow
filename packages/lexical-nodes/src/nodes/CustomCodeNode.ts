...
export class CustomCodeNode extends CodeNode {
  ...
  setLanguage(language: string | null | undefined): this {
    ...
    // Aliases normalize here as they do in the constructor: a block created
    // from a markdown fence or restored from JSON arrives as `js`, and the
    // language label and highlighter look the canonical name up.
    return super.setLanguage(
