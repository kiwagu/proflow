...
import type { FileDecoratorProps, FileNode } from './nodes/FileNode';
import type {
...
// Generic component type. The package is headless: on the front end the app
// narrows this to its React component type (a function component returning
// ReactNode); on the backend nothing narrows it and decorators stay unset.
...
export interface NodeDecoratorMap {
  ...
  FileNode: {
    klass: typeof FileNode;
    props: FileDecoratorProps;
  };
  ImageNode: {
