 ...
 *
 * `active` drives the pressed look (filled `--secondary` vs. hairline outline).
 * When `onRemove` is supplied a trailing X appears; activating it removes the
 * chip without toggling. Semantic tokens only; Lucide at control size.
 */
