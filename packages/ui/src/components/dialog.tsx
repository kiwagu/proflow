...
/**
 * Dialog — a centered modal, the sibling of `Sheet` (both wrap the same
 * `radix-ui` Dialog primitive; Sheet styles it as an edge drawer, this one as a
 * centered card). Use it for focused create/confirm flows that should take over
 * the viewport center rather than slide in from a side. Semantic tokens only.
 */
