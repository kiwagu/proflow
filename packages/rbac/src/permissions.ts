export const RBAC_PERMISSION_KEYS = {
  ...
  spaceDocumentsRead: 'space.documents.read',
  spaceDocumentsCreate: 'space.documents.create',
  spaceDocumentsUpdate: 'space.documents.update',
  spaceDocumentsDelete: 'space.documents.delete',
